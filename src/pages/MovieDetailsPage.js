    ...
    return (
        <div className='py-10 page-container'>
            <div className="w-full h-[600px] relative" >
                ...
                <div className="w-full h-full bg-no-repeat bg-cover" style={{ backgroundImage: `url(${tmdbAPI.imageOriginal(backdrop_path)})`, }}></div>
            </div>
                        ...
                        {results.slice(0, 2).map((item) => (
                            <div key={item.id}>
                                ...
                                <div className='w-full aspect-video'>
                                    <iframe width="885" height="498" src={`https://www.youtube.com/embed/${item.key}`} title={item.name} frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen className='object-fill w-full h-full'></iframe>
                                </div>
                            </div>
                        ))}
                    </div>
